...
namespace Trena
{
	...
	public class Furniture : Product
	{
		...
		public static Product operator +(Furniture p1, Furniture p2)
		{
			if (p1 == null || p2 == null)
		...
		public static Product operator -(Furniture p1, int x)
		{
			if (x > p1.numerous)
		...
		public override bool Equals(object obj)
		{
			if (obj == null)
				return false;
			Furniture F = obj as Furniture;
			if (F as Furniture == null)
				return false;
